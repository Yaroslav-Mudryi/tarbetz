    ...
    <div id="newOddModal" class="modal fade show" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.storeTeamsFromOdd')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                                ...
                                <tr>
                                    ...
                                    <th scope="col"><?php echo app('translator')->get('Name'); ?></th>
                                    <th scope="col" class="text-center"><?php echo app('translator')->get('Tournament'); ?></th>
                                    <th scope="col" class="text-center"><?php echo app('translator')->get('Game Category'); ?></th>
                                    <th scope="col" class="text-center"><?php echo app('translator')->get('Status'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $teams_from_odds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center">
                                            <input type="checkbox" id="chk-<?php echo e($item->key); ?>" data-level="2"
                                                class="form-check-input row-tic tic-check" name="checks_add[]" value="<?php echo e($item->name); ?>:<?php echo e($item->category_id); ?>:<?php echo e($item->active); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\GitHub\public_html\resources\views/admin/team/list.blade.php ENDPATH**/ ?>