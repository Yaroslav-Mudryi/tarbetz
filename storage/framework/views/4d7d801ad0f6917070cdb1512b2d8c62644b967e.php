        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            <ul class="navbar-nav float-left mr-auto ml-3 pl-1">
                ...
                <!-- <li class="nav-item flex-center" style="margin-left: 30px" id="sync_odd">
                    <a href="<?php echo e(route('admin.content.sync_odds')); ?>" class="btn btn-sm btn-primary mr-2">
                        <span><i class="fa fa-plus-circle"></i> <?php echo app('translator')->get('Sync With Odds'); ?></span>
                    </a>
                </li> -->
            </ul>
...
<?php /**PATH /home/starpvfh/public_html/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>