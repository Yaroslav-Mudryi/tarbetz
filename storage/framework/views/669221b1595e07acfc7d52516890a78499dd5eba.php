    ...
    <div id="newOddModal" class="modal fade show" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.storeCategoriesFromOdd')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                                ...
                                <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $categories_from_odds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center">
                                            <input type="checkbox" id="chk-<?php echo e($item->key); ?>" data-level="2"
                                                class="form-check-input row-tic tic-check" name="checks_add[]" value="<?php echo e($item->key); ?>:<?php echo e($item->active); ?>"
                                        ...
                                        <td data-label="<?php echo app('translator')->get('Icon'); ?>" class="text-lg-center text-right">
                                            <select name="icons_add[]" id="icons_add[]" class="form-control" class="selectpicker"
                                                    data-live-search="true">
                                                <option value="0" selected disabled><?php echo app('translator')->get('Select Icon'); ?></option>
                                                <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($value); ?>" data-content="<?php echo e($value); ?> <?php echo e($key); ?>">
                                                        <i> <?php echo e($key); ?> </i>
                                                    </option>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\GitHub\public_html\resources\views/admin/category/list.blade.php ENDPATH**/ ?>