<!-- live match table -->
<div v-if="showType == 'live'"  v-for="(item, index) in allSports_filter" class="table-parent table-responsive d-sm-block d-none live">
...
<div  v-if="showType == 'upcoming'"  v-for="(item, index) in upcoming_filter" class="table-parent table-responsive d-sm-block d-none incoming">
    <table class="table table-striped">
        <thead>
        <tr>
            <th class="text-center">
...
<?php /**PATH F:\GitHub\public_html\resources\views/themes/betting/partials/home/content.blade.php ENDPATH**/ ?>