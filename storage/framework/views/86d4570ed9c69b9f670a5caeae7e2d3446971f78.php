            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <?php if(adminAccessRoute(config('role.manage_game.access.add'))): ?>
                    <div>
                        ...
                        data-toggle="modal">
                            <span><i class="fa fa-plus-circle"></i> <?php echo app('translator')->get('Add New From Odd'); ?></span>
                        </a> -->
                    </div>
                <?php endif; ?>
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?php echo app('translator')->get('Start Date'); ?> (<?php echo e(config('app.timezone')); ?>)</th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $matches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="text-center">
                                <input type="checkbox" id="chk-<?php echo e($item->id); ?>" data-level="1"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row  mb-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark"><?php echo app('translator')->get('Start Date'); ?> (<?php echo e(config('app.timezone')); ?>) <span
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark"><?php echo app('translator')->get('End Date'); ?> (<?php echo e(config('app.timezone')); ?>) <span
                                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div id="newOddModal" class="modal fade show" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title"><?php echo app('translator')->get('Add New From Odd'); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?php echo e(route('admin.storeMatchesFromOdd')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                                ...
                                <tr>
                                    ...
                                    <th scope="col"><?php echo app('translator')->get('Team 01'); ?></th>
                                    <th scope="col"><?php echo app('translator')->get('Team 02'); ?></th>
                                    <th scope="col"><?php echo app('translator')->get('Tour'); ?></th>
                                    <th scope="col"><?php echo app('translator')->get('Game Category'); ?></th>
                                    <th scope="col"><?php echo app('translator')->get('Start Date'); ?> (<?php echo e(config('app.timezone')); ?>)</th>
                                    <th scope="col" class="text-center"><?php echo app('translator')->get('Status'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $matches_from_odd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center">
                                            <input type="checkbox" id="chk-<?php echo e($item->key); ?>" data-level="2"
                                                class="form-check-input row-tic tic-check" name="checks_add[]"
                                                value="<?php echo e($item->key); ?>:<?php echo e($item->team01_id); ?>:<?php echo e($item->team02_id); ?>:<?php echo e($item->category_id); ?>:<?php echo e($item->tour_id); ?>"
                                                data-id="<?php echo e($item->key); ?>">
                                            <label for="chk-<?php echo e($item->key); ?>"></label>
                                        </td>

                                        <td data-label="<?php echo app('translator')->get('Team 01'); ?>">
                                            <?php echo e($item->team01); ?>

                                        </td>

                                        <td data-label="<?php echo app('translator')->get('Team 02'); ?>">
                                            <?php echo e($item->team02); ?>

                                        </td>

                                        <td data-label="<?php echo app('translator')->get('Tournament'); ?>">
                                            <?php echo e($item->tour); ?>

                                        </td>

                                        <td data-label="<?php echo app('translator')->get('Game Category'); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\GitHub\public_html\resources\views/admin/match/list.blade.php ENDPATH**/ ?>